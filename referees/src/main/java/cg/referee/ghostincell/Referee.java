package cg.referee.ghostincell;
...
class Referee extends MultiReferee {
    ...
    private Object translate(String incAction, int id, int id1) {
        return null;
    }

    private void addToolTip(int id, Object bombAction) {
    }

    private Object translate(String bombAction, int id, int id1, int id2) {
        return null;
    }
